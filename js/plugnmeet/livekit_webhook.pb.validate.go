...
func (m *WebhookEvent) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetEgressInfo()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, WebhookEventValidationError{
					field:  "EgressInfo",
	...
	} else if v, ok := interface{}(m.GetEgressInfo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return WebhookEventValidationError{
				field:  "EgressInfo",
				reason: "embedded message failed validation",
	...
	if all {
		switch v := interface{}(m.GetIngressInfo()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, WebhookEventValidationError{
					field:  "IngressInfo",
	...
	} else if v, ok := interface{}(m.GetIngressInfo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
			return WebhookEventValidationError{
				field:  "IngressInfo",
				reason: "embedded message failed validation",
