...
var file_plugnmeet_breakout_room_proto_rawDesc = []byte{
	...
	0x0a, 0x05, 0x5f, 0x72, 0x6f, 0x6f, 0x6d, 0x42, 0xa3, 0x01, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x2e,
	0x70, 0x6c, 0x75, 0x67, 0x6e, 0x6d, 0x65, 0x65, 0x74, 0x42, 0x1a, 0x50, 0x6c, 0x75, 0x67, 0x6e,
	0x6d, 0x65, 0x65, 0x74, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x6f, 0x75, 0x74, 0x52, 0x6f, 0x6f, 0x6d,
...
func file_plugnmeet_breakout_room_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_plugnmeet_breakout_room_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_breakout_room_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_breakout_room_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_breakout_room_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_breakout_room_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_breakout_room_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_breakout_room_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_breakout_room_proto_msgTypes[7].Exporter = func(v any, i int) any {
