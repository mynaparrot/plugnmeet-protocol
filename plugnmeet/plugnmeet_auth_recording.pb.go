...
var file_plugnmeet_auth_recording_proto_rawDesc = []byte{
	...
	0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0xa4, 0x01, 0x0a,
	0x0d, 0x63, 0x6f, 0x6d, 0x2e, 0x70, 0x6c, 0x75, 0x67, 0x6e, 0x6d, 0x65, 0x65, 0x74, 0x42, 0x1b,
	0x50, 0x6c, 0x75, 0x67, 0x6e, 0x6d, 0x65, 0x65, 0x74, 0x41, 0x75, 0x74, 0x68, 0x52, 0x65, 0x63,
	0x6f, 0x72, 0x64, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x32, 0x67,
...
func file_plugnmeet_auth_recording_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_plugnmeet_auth_recording_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_plugnmeet_auth_recording_proto_msgTypes[9].Exporter = func(v any, i int) any {
