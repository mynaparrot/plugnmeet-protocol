...
const (
	...
	RoomArtifactType_SPEECH_TRANSCRIPTION             RoomArtifactType = 2
	RoomArtifactType_SPEECH_TRANSCRIPTION_USAGE       RoomArtifactType = 3
	RoomArtifactType_SYNTHESIZED_SPEECH_USAGE         RoomArtifactType = 4
	RoomArtifactType_CHAT_TRANSLATION_USAGE           RoomArtifactType = 5
	RoomArtifactType_AI_TEXT_CHAT_INTERACTION_USAGE   RoomArtifactType = 6
	RoomArtifactType_AI_TEXT_CHAT_SUMMARIZATION_USAGE RoomArtifactType = 7
)
...
var (
	RoomArtifactType_name = map[int32]string{
		...
		3: "SPEECH_TRANSCRIPTION_USAGE",
		4: "SYNTHESIZED_SPEECH_USAGE",
		5: "CHAT_TRANSLATION_USAGE",
		6: "AI_TEXT_CHAT_INTERACTION_USAGE",
		7: "AI_TEXT_CHAT_SUMMARIZATION_USAGE",
	}
	RoomArtifactType_value = map[string]int32{
		"UNKNOWN_ARTIFACT":                 0,
		"MEETING_SUMMARY":                  1,
		"SPEECH_TRANSCRIPTION":             2,
		"SPEECH_TRANSCRIPTION_USAGE":       3,
		"SYNTHESIZED_SPEECH_USAGE":         4,
		"CHAT_TRANSLATION_USAGE":           5,
		"AI_TEXT_CHAT_INTERACTION_USAGE":   6,
		"AI_TEXT_CHAT_SUMMARIZATION_USAGE": 7,
	}
)
...
const file_plugnmeet_room_artifacts_proto_rawDesc = "" +
	...
	"artifactId\x12;\n" +
	"\bmetadata\x18\x03 \x01(\v2\x1f.plugnmeet.RoomArtifactMetadataR\bmetadata*\xfb\x01\n" +
	"\x10RoomArtifactType\x12\x14\n" +
	"\x10UNKNOWN_ARTIFACT\x10\x00\x12\x13\n" +
	"\x0fMEETING_SUMMARY\x10\x01\x12\x18\n" +
	"\x14SPEECH_TRANSCRIPTION\x10\x02\x12\x1e\n" +
	"\x1aSPEECH_TRANSCRIPTION_USAGE\x10\x03\x12\x1c\n" +
	"\x18SYNTHESIZED_SPEECH_USAGE\x10\x04\x12\x1a\n" +
	"\x16CHAT_TRANSLATION_USAGE\x10\x05\x12\"\n" +
	"\x1eAI_TEXT_CHAT_INTERACTION_USAGE\x10\x06\x12$\n" +
	" AI_TEXT_CHAT_SUMMARIZATION_USAGE\x10\aB\xa4\x01\n" +
