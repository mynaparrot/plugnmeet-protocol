...
const (
	...
	DataMsgBodyType_NOTEPAD_SYNC_REQUEST             DataMsgBodyType = 21
	DataMsgBodyType_NOTEPAD_SYNC_RESPONSE            DataMsgBodyType = 22
	DataMsgBodyType_NOTEPAD_UPDATE                   DataMsgBodyType = 23
	DataMsgBodyType_NOTEPAD_AWARENESS                DataMsgBodyType = 24
)
...
var (
	DataMsgBodyType_name = map[int32]string{
		...
		20: "REACTION",
		21: "NOTEPAD_SYNC_REQUEST",
		22: "NOTEPAD_SYNC_RESPONSE",
		23: "NOTEPAD_UPDATE",
		24: "NOTEPAD_AWARENESS",
	}
	DataMsgBodyType_value = map[string]int32{
		...
		"REACTION":                         20,
		"NOTEPAD_SYNC_REQUEST":             21,
		"NOTEPAD_SYNC_RESPONSE":            22,
		"NOTEPAD_UPDATE":                   23,
		"NOTEPAD_AWARENESS":                24,
	}
)
...
type DataChannelMessage struct {
	...
	BinMessage    []byte                 `protobuf:"bytes,6,opt,name=bin_message,json=binMessage,proto3,oneof" json:"bin_message,omitempty"`
...
func (x *DataChannelMessage) GetBinMessage() []byte {
	if x != nil {
		return x.BinMessage
	}
	return nil
...
const file_plugnmeet_datamessage_proto_rawDesc = "" +
	"\n" +
	"\x1bplugnmeet_datamessage.proto\x12\tplugnmeet\"\xf8\x01\n" +
	...
	"\bREACTION\x10\x14\x12\x18\n" +
	"\x14NOTEPAD_SYNC_REQUEST\x10\x15\x12\x19\n" +
	"\x15NOTEPAD_SYNC_RESPONSE\x10\x16\x12\x12\n" +
	"\x0eNOTEPAD_UPDATE\x10\x17\x12\x15\n" +
	"\x11NOTEPAD_AWARENESS\x10\x18B\xa2\x01\n" +
