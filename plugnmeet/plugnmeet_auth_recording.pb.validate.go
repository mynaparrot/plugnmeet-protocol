...
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *MergeRecordingsReq) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on MergeRecordingsReq with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// MergeRecordingsReqMultiError, or nil if none found.
func (m *MergeRecordingsReq) ValidateAll() error {
	return m.validate(true)
}

func (m *MergeRecordingsReq) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// MergeRecordingsReqMultiError is an error wrapping multiple validation errors
// returned by MergeRecordingsReq.ValidateAll() if the designated constraints
// aren't met.
type MergeRecordingsReqMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m MergeRecordingsReqMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m MergeRecordingsReqMultiError) AllErrors() []error { return m }

// MergeRecordingsReqValidationError is the validation error returned by
// MergeRecordingsReq.Validate if the designated constraints aren't met.
type MergeRecordingsReqValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e MergeRecordingsReqValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e MergeRecordingsReqValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e MergeRecordingsReqValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e MergeRecordingsReqValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e MergeRecordingsReqValidationError) ErrorName() string {
	return "MergeRecordingsReqValidationError"
}

// Error satisfies the builtin error interface
func (e MergeRecordingsReqValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sMergeRecordingsReq.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = MergeRecordingsReqValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = MergeRecordingsReqValidationError{}
