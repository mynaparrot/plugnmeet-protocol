...
const file_plugnmeet_common_api_proto_rawDesc = "" +
	...
	"\"enabled_self_insert_encryption_key\x18\b \x01(\bH\x04R\x1eenabledSelfInsertEncryptionKey\x88\x01\x01B\x11\n" +
	"\x0f_server_versionB\n" +
	"\n" +
	"\b_room_idB\n" +
	"\n" +
	"\b_user_idB\x10\n" +
	"\x0e_nats_subjectsB%\n" +
	"#_enabled_self_insert_encryption_key\"\xb7\x01\n" +
