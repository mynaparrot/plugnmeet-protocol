...
// Validate checks the field values on EnableSipDialInReq with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on EnableSipDialInReq with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// EnableSipDialInReqMultiError, or nil if none found.
func (m *EnableSipDialInReq) ValidateAll() error {
	return m.validate(true)
}

func (m *EnableSipDialInReq) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return EnableSipDialInReqMultiError(errors)
	}

	return nil
}

// EnableSipDialInReqMultiError is an error wrapping multiple validation errors
// returned by EnableSipDialInReq.ValidateAll() if the designated constraints
// aren't met.
type EnableSipDialInReqMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m EnableSipDialInReqMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m EnableSipDialInReqMultiError) AllErrors() []error { return m }

// EnableSipDialInReqValidationError is the validation error returned by
// EnableSipDialInReq.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e EnableSipDialInReqValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e EnableSipDialInReqValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e EnableSipDialInReqValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e EnableSipDialInReqValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e EnableSipDialInReqValidationError) ErrorName() string {
	return "EnableSipDialInReqValidationError"
}

// Error satisfies the builtin error interface
func (e EnableSipDialInReqValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sEnableSipDialInReq.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = EnableSipDialInReqValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = EnableSipDialInReqValidationError{}
