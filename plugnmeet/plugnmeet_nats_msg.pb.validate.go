...
func (m *TurnCredentials) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TurnCredentials with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TurnCredentialsMultiError, or nil if none found.
func (m *TurnCredentials) ValidateAll() error {
	return m.validate(true)
}

func (m *TurnCredentials) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// TurnCredentialsMultiError is an error wrapping multiple validation errors
// returned by TurnCredentials.ValidateAll() if the designated constraints
// aren't met.
type TurnCredentialsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TurnCredentialsMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TurnCredentialsMultiError) AllErrors() []error { return m }

// TurnCredentialsValidationError is the validation error returned by
// TurnCredentials.Validate if the designated constraints aren't met.
type TurnCredentialsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TurnCredentialsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TurnCredentialsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TurnCredentialsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TurnCredentialsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TurnCredentialsValidationError) ErrorName() string { return "TurnCredentialsValidationError" }

// Error satisfies the builtin error interface
func (e TurnCredentialsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sTurnCredentials.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TurnCredentialsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = TurnCredentialsValidationError{}
...
func (m *MediaServerConnInfo) validate(all bool) error {
	...
	if m.TurnCredentials != nil {
		...
		if all {
			switch v := interface{}(m.GetTurnCredentials()).(type) {
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, MediaServerConnInfoValidationError{
						field:  "TurnCredentials",
						reason: "embedded message failed validation",
						cause:  err,
					})
				}
		...
		} else if v, ok := interface{}(m.GetTurnCredentials()).(interface{ Validate() error }); ok {
			if err := v.Validate(); err != nil {
...
func (m *ChatMeta) validate(all bool) error {
	...
	if m.ReplyToName != nil {
		// no validation rules for ReplyToName
	}

	if m.ReplyToText != nil {
		// no validation rules for ReplyToText
	}
...
// Validate checks the field values on SessionDataHeader with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *SessionDataHeader) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SessionDataHeader with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SessionDataHeaderMultiError, or nil if none found.
func (m *SessionDataHeader) ValidateAll() error {
	return m.validate(true)
}

func (m *SessionDataHeader) validate(all bool) error {
	if m == nil {
		return nil
	}
...
// SessionDataHeaderMultiError is an error wrapping multiple validation errors
// returned by SessionDataHeader.ValidateAll() if the designated constraints
// aren't met.
type SessionDataHeaderMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SessionDataHeaderMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SessionDataHeaderMultiError) AllErrors() []error { return m }

// SessionDataHeaderValidationError is the validation error returned by
// SessionDataHeader.Validate if the designated constraints aren't met.
type SessionDataHeaderValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SessionDataHeaderValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SessionDataHeaderValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SessionDataHeaderValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SessionDataHeaderValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SessionDataHeaderValidationError) ErrorName() string {
	return "SessionDataHeaderValidationError"
}

// Error satisfies the builtin error interface
func (e SessionDataHeaderValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSessionDataHeader.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SessionDataHeaderValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SessionDataHeaderValidationError{}
